...
<html lang="en">
  <head>
    ...
    <title>QBOT</title>
    <link rel="stylesheet" href="{{ asset('auto/css/main.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/home.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/menu.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/cart.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/upsell.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/payment.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/confirmation.css')}}" />
    <link rel="stylesheet" href="{{ asset('auto/css/selection.css')}}" />
    {{-- <style>
        .fullscreen-btn {
      padding: 10px 20px;
      font-size: 16px;
...
@keyframes fadeInUp {
    ...
    <div id="app">
      ...
      <div id="menu-page" class="page">
        <header class="banner-header">
          <img class="img-banner" src="{{ asset('images/autohero.webp')}}" alt="Delicious Burger Special" />
        </header>
  ...
  <div class="payment-container">
    ...
    <script src="{{ asset('auto/js/data.js')}}"></script>
    <script src="{{ asset('auto/js/main.js')}}"></script>
    <script>
